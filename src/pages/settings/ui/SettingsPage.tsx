    ...
    >
      ...
      >
        <div className="settings-page__migration-note">
          <strong>Повний технічний звіт</strong>
          <p>
            Журнал зберігає повний текст і stack помилок без приховування або
            скорочення. Помилки можуть містити введені значення, адреси,
            ідентифікатори чи інші приватні дані, тому перевірте звіт перед
            передаванням. Журнал залишається лише на цьому пристрої та не входить до
            JSON backup.
          </p>
        </div>
